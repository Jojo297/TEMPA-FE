...
export function SearchMajors() {
  ...
  const { majors, isLoadingMajors, errorMajors, fetchMajor } =
    useGetAllMajors();
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="w-[200px] justify-between text-gray-400 text-sm overflow-hidden whitespace-nowrap text-ellipsis"
        >
          {selectedMajor
