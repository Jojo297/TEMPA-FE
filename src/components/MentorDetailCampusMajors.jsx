...
import useGetAllMajorsCampus from "@/hooks/hooksMentor/useGetAllMajors";
import { toast } from "sonner";
import useEditCampusMajors from "@/hooks/hooksMentor/useEditCampusMajors";
...
export default function MentorDetailCampusMajors({
  majors,
  campusId,
  refetchCampusData,
}) {
                ...
                {majors.map((item) => (
                  ...
                  >
                    ...
                    <AccordionContent className="p-6 bg-gray-50 border-t border-gray-200">
                      ...
                      <div className="text-gray-800 mb-6 w-full overflow-hidden break-words">
                        <div
