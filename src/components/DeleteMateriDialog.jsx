import useDeleteMateri from "@/hooks/hooksCampus/useDeleteMateri";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
function DeleteMateriDialog({ idMateri, materiName, onDeleteSuccess, token }) {
...
export default DeleteMateriDialog;
