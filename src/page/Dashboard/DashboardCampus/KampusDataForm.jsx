  ...
  return (
    <SidebarCampus>
      <div className="min-h-screen flex flex-col bg-white">
        {/* Hero Section */}
        <section className="bg-[#013D3A] w-[85%] md:w-[90%] mx-auto text-center text-white mt-8 py-6 rounded-md">
          <h2 className="text-2xl font-semibold">Bergabung Sebagai Mitra</h2>
          <p className="text-gray-300 text-sm mt-1">
            Kami membutuhkan beberapa informasi. Silakan isi data kampus di
            bawah ini.
          </p>
        </section>
