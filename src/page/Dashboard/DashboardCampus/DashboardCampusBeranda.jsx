...
export default function DashboardBerandaCampus() {
  ...
  return (
    <SidebarCampus>
      <div className="flex-1 flex flex-col bg-[#F4FAF9] text-[#013D3A] min-h-screen">
        {/* HEADER */}
        <div className="px-6 md:px-10 pt-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold mb-6 text-[#013D3A]">
              SELAMAT DATANG,
              <br /> MITRA TEMPA
            </h1>
        ...
        <footer className="px-6 md:px-10 pb-8">
          <div className="bg-transparent text-right text-xs text-gray-500">
